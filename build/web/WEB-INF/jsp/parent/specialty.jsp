...
<html>
    <head>
        ...
        <title>Viewing Specialty | Edelweiss Pediatrics</title>
    ...
    <body>
        <div id="container">
            ...
            <div id="wrapper">
                ...
                <br class="clear" />
                <div id="workarea" class="clearfix">
                    <h2>Specialty -- ${spec}</h2>
                        <div class="breadcrumbs">
                            <c:forEach items="${peds_list}" var="specs">
                                &rsaquo;
                                <spring:url value="/pediatricians/${specs.id}/" var="index" htmlEscape="true"/>
                                <a href="${index}" >
