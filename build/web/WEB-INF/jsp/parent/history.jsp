            ...
            <div id="wrapper">
                ...
                <div id="workarea" class="clearfix">
                    ...
                    <ul class="object-tools">
                        <li>
                            <spring:url value="addkid/" var="add_kid" htmlEscape="true"/>
                            <a href="${add_kid}" class="addlink">Add children</a>
                        </li>
                    </ul>
                    <div class="breadcrumbs">
                        <c:forEach items="${kids}" var="specs">
                            &rsaquo;
                            <spring:url value="${specs.id}/" var="index" htmlEscape="true"/>
                            <a href="${index}" >
                                <c:out value="${specs.name}"/> <c:out value="${l_name}"/> 
                                <br class="clear" />
                            </a>                
                        </c:forEach>
                    </div>
