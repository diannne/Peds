...
<html>
    <head>
        ...
        <title>Edit/View clinical visit | Edelweiss Pediatrics Patient Management</title>
    ...
    <body class="auth-user change-form">
        ...
        <div id="container">
            ...
            <div class="breadcrumbs">
                ...
                <spring:url value="/secret/patient/${pid}/kid/${kid}/" var="kid" htmlEscape="true"/>
                &rsaquo; <a href="${kid}">${f_name} ${lp_name}</a>
                &rsaquo;  Edit/View clinical visit
            </div>  

            <div id="content" class="colM">
                <h1>Edit/View clinical visit</h1>
                        ...
                        <div>
                            <fieldset class="module aligned ">
                                ...
                                <div class="form-row">
                                    <div>
                                        <label>Date:</label>
                                        <input id="datetimepicker1" name="datetimepicker1" type="text" value="${date}">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div>
                                        ...
                                        <input id="datetimepicker2" name="datetimepicker2" type="text" value="${s_time}">                                        
                                    </div>
                                </div>
                                <script type="text/javascript">
                                ...
                                <div class="form-row">
                                    <div>
                                        ...
                                        <input id="datetimepicker3" name="datetimepicker3" type="text" value="${e_time}">
                                    </div>
                                </div>
                                <script type="text/javascript">
