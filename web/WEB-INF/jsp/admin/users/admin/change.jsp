...
<html>
    <head>
        ...
        <title>Select admins to change | Edelweiss Pediatrics admin</title>
    ...
    <body class="change-list">
        <div id="container">
            ...
            <div id="content" class="flex">
                <h1>Select admin to change</h1>
                <div id="content-main">
                    <ul class="object-tools">
                        <li>
                            <spring:url value="/admin/users/admin/add" var="add_admin" htmlEscape="true"/>
                            <a href="${add_admin}" class="addlink">Add admin</a>
                        </li>
                    </ul>
                                ...
                                <div class="actions">
                                    <label>Action: 
                                        <select name="action">
                                            ...
                                            <option value="delete_selected">Delete selected admins</option>
                                        </select>
                                    </label>
                                                ...
                                                <tr class="row1">
                                                    <td class="action-checkbox">
                                                        <input type="checkbox" name="_selected_action" 
                                                               value="<c:out value="${admins.username}"/>" class="action-select"/>
                                                    </td>
                                                    <th>
                                                        <a href="${admins.username}/" >
                                                            <c:out value="${admins.username}"/>
                                                        </a>
                                                    </th>
                                                    <td><c:out value="${admins.enabled}"/></td>
                                                    <td>admin</td>                                                
                                                </tr>
                                            </c:forEach>
                                        </tbody>
